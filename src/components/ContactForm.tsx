...
// Master office list
const allOffices: Record<string, Array<{
  name: string;
  address: string; // with \n
  phones?: string[];
  fax?: string;
...
const ContactForm: React.FC = () => {
  ...
  const topFourOffices = useMemo(() => {
    const withCountry = Object.entries(allOffices).flatMap(([country, offices]) => offices.map(o => ({
      ...o,
      country
    })));
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          ...
          <div className="space-y-6">
            <h3 className="text-2xl font-bold flex items-center gap-2" style={{
            color: BRAND.blue
          }}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {topFourOffices.map((office, idx) => <motion.div key={`${office.country}-${office.name}-${idx}`} initial={{
              opacity: 0,
              y: 16
            }} whileInView={{
              opacity: 1,
              ...
              once: true
            }} className="p-5 rounded-xl shadow-md border bg-white" style={{
              borderColor: BRAND.gold
            }}>
                  <div className="flex items-center justify-between mb-2">
                    <h5 className="text-base font-semibold flex items-center gap-2" style={{
                  color: BRAND.blue
                }}>
                  ...
                  <div className="space-y-3">
                    ...
                    {office.phones?.map((phone, i) => <div key={i} className="flex items-center gap-3">
                    ...
                    {office.fax && <div className="flex items-center gap-3">
                        <Phone className="w-5 h-5" style={{
                    color: BRAND.gold
                  }} />
                    ...
                    {office.emails?.map((email, i) => <div key={i} className="flex items-center gap-3">
            ...
            <form onSubmit={handleSubmit} ref={formRef} className="space-y-6">
              ...
              background: "#fff"
                ...
                <Select value={selectedLocation} onValueChange={setSelectedLocation}>
                  ...
                  <SelectContent>
                    {locationOptions.map(loc => <SelectItem key={loc} value={loc}>
                        {loc}
                      </SelectItem>)}
                  </SelectContent>
                </Select>
