...
const countries: CountryData[] = [{
  ...
  country: "SRI LANKA",
  company: "GC",
  website: "https://www.globalconsol.com/sri-lanka/home",
  priority: 2,
  flag: "/lk.svg"
}, {
  country: "MYANMAR",
  company: "GC",
  website: "https://www.globalconsol.com/myanmar/home",
  priority: 3,
  flag: "/mm.svg"
}, {
  country: "BANGLADESH",
  company: "GC",
  website: "https://www.globalconsol.com/bangladesh/home",
  priority: 4,
  flag: "/bd.svg"
}, {
  country: "PAKISTAN",
  company: "GC",
  website: "https://www.globalconsol.com/pakistan/home",
  priority: 5,
  flag: "/pk.svg"
},
...
const CountrySelector = () => {
  ...
  const displayCountry = countries.find(c => ipCountry && (c.country.toUpperCase() === ipCountry.name?.toUpperCase() || c.flag?.toLowerCase().includes(ipCountry.code?.toLowerCase()))) || countries.find(c => c.country.toUpperCase() === currentCountryName) || singaporeCountry;
  const availableCountries = countries.filter(c => c.country.toUpperCase() !== currentCountryName && (!c.visibilityByCountry || c.visibilityByCountry[currentCountryName] !== false));
  ...
  return <div ref={dropdownRef} className="relative z-50 flex items-center gap-2">
      <DropdownMenu open={isOpen} onOpenChange={setIsOpen}>
        ...
        <DropdownMenuContent align="center" className="w-[280px] max-h-screen h-[90vh] border border-amber-100 bg-white p-2 rounded-lg shadow-lg overflow-y-auto">
          <ScrollArea className="h-full w-full pr-2 custom-scrollbar">
            <div className="grid grid-cols-1 gap-1 p-1">
              {sortedCountries.map(country => <DropdownMenuItem key={country.country} onSelect={e => {
              e.preventDefault();
              handleCountrySelect(country);
                ...
                scale: 1.05
                    ...
                    <div className="flex-shrink-0">
                      {country.flag ? <img src={country.flag} alt={`${country.country} flag`} className="w-6 h-6 rounded-sm shadow-sm object-cover" /> : <div className="w-6 h-6 bg-gray-200 rounded-sm flex items-center justify-center">
