...
const Navigation = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 w-full z-50 shadow-md bg-white/90 backdrop-blur supports-[backdrop-filter]:backdrop-blur transition-all duration-300">
      {/* Main Nav Bar */}
      <div className="container mx-auto px-3 sm:px-4 md:px-6 py-2 sm:py-4 lg:py-[18px]">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-5">
            <Link
              to={getNavLink("/home")}
              className={`nav-link font-medium text-sm xl:text-base hover:text-amass-blue transition-colors ${
            ...
            >
              <DropdownMenuTrigger
                className={`nav-link font-medium text-sm xl:text-base flex items-center gap-1 hover:text-amass-blue transition-colors ${
            ...
            <Link
              ...
              className={`nav-link font-medium text-sm xl:text-base transition-colors ${
            ...
            <nav className="flex flex-col space-y-4">
              {[
                ...
                <Link
                  ...
                  className={`font-medium py-2 text-base hover:text-amass-blue transition-colors ${
