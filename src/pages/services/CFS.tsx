            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    Our CFS features a 4,700 square meter covered area and a 500 square meter open yard to assist you with comprehensive logistics solutions.
                  </p>
                </div>
                ...
                <div className="bg-kargon-blue/10 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    <li>• 4,700 sqm covered warehouse area</li>
                    <li>• 500 sqm open yard space</li>
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <img alt="CFS Warehouse" loading="lazy" className="w-full h-96 object-cover" src="/warehousing.png" />
