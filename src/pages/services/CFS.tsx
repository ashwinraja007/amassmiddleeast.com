              ...
              >
                <div className="space-y-4">
                  ...
                  <p className="text-lg leading-relaxed text-gray-700">
                    Take full advantage of our state-of-the-art CFS, which is equipped with the latest equipment,
                    technology and staffed by experienced professionals at every level. Our warehouses are designed to
                    handle your cargo efficiently across all regions.
                  </p>
                  <p className="text-lg leading-relaxed text-gray-700">
                    Our CFS features a 7000 square meter covered area and a 1000 square meter open yard to assist you
                ...
                <div className="bg-kargon-blue/10 rounded-xl p-6">
                  ...
                  <ul className="space-y-2 text-gray-700">
                    ...
                    <li>• 1,000 sqm open yard space</li>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
              {cfsImages.map((img, i) => (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="rounded-xl overflow-hidden shadow-lg hover:scale-[1.03] transition-transform duration-300"
                >
                  <img
                    src={img}
                    alt={`CFS image ${i + 1}`}
